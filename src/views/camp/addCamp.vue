<template>
  <div>
      ...
      <el-card class="box-card">
          ...
          <el-form class="addCampForm" :model="addCampForm" :rules="addCampRules" ref="addCampRef" label-width="100px">
              <el-row>
                  <el-col :offset="1" :span="6">
                    ...
                    <el-form-item v-model="addCampForm.campPicture" class="formItem" label="营地照片" prop="picture" required>
                        <el-upload
                    ...
                    <el-form-item class="formItem" label="营地电话" prop="campPhone" required>
                        <el-input type="text" placeholder="请输入联系电话" v-model="addCampForm.campPhone"/>
                    </el-form-item>
                    <el-form-item class="formItem" label="营地地址" prop="campAddress" required>
                        <el-input type="text" placeholder="请输入营地地址" v-model="addCampForm.campAddress"/>
                    </el-form-item>
                    <el-form-item class="formItem" label="营业执照" prop="campLicense" v-model="addCampForm.campLicense" required>
                        <el-upload
                            class="avatar-uploader"
                            action="https://jsonplaceholder.typicode.com/posts/"
                            :show-file-list="false"
                    ...
                    <el-form-item class="formItem" label="信用注册号" prop="licenseCode" required>
                        <el-input type="text" placeholder="请输入管理员姓名" v-model="addCampForm.licenseCode"/>
                    </el-form-item>
                    <el-form-item class="formItem" label="营地简介" prop="campDescribe" required>
                        <el-input type="textarea" maxlength="300" minlength="100" show-word-limit placeholder="请输入营地详情" v-model="addCampForm.campDescribe"/>
                    </el-form-item>
                  </el-col>
          ...
          <div class="foot">
              <el-button type="primary" size="mini" @click="createCamp">立即创建</el-button>
